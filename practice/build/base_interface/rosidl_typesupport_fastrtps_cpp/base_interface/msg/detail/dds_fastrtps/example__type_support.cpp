...
#include "base_interface/msg/detail/example__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const base_interface::msg::Example & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  base_interface::msg::Example & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = base_interface::msg::Example;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const base_interface::msg::Example *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<base_interface::msg::Example *>(
    untyped_ros_message);
...
{
  return &base_interface::msg::typesupport_fastrtps_cpp::_Example__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_interface, msg, Example)() {
  return &base_interface::msg::typesupport_fastrtps_cpp::_Example__handle;
}
