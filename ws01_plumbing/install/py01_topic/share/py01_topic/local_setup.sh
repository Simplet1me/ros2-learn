...
: ${AMENT_CURRENT_PREFIX:="/home/simpletime/ws01_plumbing/install/py01_topic"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/py01_topic/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/py01_topic/environment/path.sh"
