...
#ifndef BASE_INTERFACES__SRV__DETAIL__RECHARGE__FUNCTIONS_H_
#define BASE_INTERFACES__SRV__DETAIL__RECHARGE__FUNCTIONS_H_
...
/// Initialize srv/Recharge message.
/**
...
/// Create srv/Recharge message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * base_interfaces__srv__Recharge_Request__init().
...
/// Destroy srv/Recharge message.
/**
 * It calls
 * base_interfaces__srv__Recharge_Request__fini()
...
/// Check for srv/Recharge message equality.
/**
...
/// Initialize array of srv/Recharge messages.
/**
...
/// Finalize array of srv/Recharge messages.
/**
 * It calls
 * base_interfaces__srv__Recharge_Request__fini()
...
/// Create array of srv/Recharge messages.
/**
 * It allocates the memory for the array and calls
 * base_interfaces__srv__Recharge_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Recharge messages.
/**
 * It calls
 * base_interfaces__srv__Recharge_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Recharge message array equality.
/**
...
/// Copy an array of srv/Recharge messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * base_interfaces__srv__Recharge_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_base_interfaces
...
/**
 * It calls
 * base_interfaces__srv__Recharge_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_base_interfaces
...
/**
 * It allocates the memory for the array and calls
 * base_interfaces__srv__Recharge_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_base_interfaces
...
/**
 * It calls
 * base_interfaces__srv__Recharge_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // BASE_INTERFACES__SRV__DETAIL__RECHARGE__FUNCTIONS_H_
