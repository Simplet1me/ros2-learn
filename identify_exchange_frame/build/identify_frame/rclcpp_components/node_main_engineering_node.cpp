...
#define NODE_MAIN_LOGGER_NAME "engineering_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libengineering.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<Identify::identify_node>";
